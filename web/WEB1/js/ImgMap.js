...
$(document).ready(function () {
	...
	$('.HS2').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('基隆市');
	...
	$('.HS3').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg41.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('新北市');
	...
	$('.HS4').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg42.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('桃園市');
	...
	$('.HS5').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg43.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('新竹縣');
	...
	$('.HS6').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg44.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('新竹市');
	...
	$('.HS7').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg45.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('苗栗縣');
	...
	$('.HS8').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg46.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('臺中市');
	...
	$('.HS9').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg47.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('彰化縣');
	...
	$('.HS10').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg48.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('雲林縣');
	...
	$('.HS11').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg49.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('南投縣');
	...
	$('.HS12').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg50.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('嘉義縣');
	...
	$('.HS14').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg51.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('嘉義市');
	...
	$('.HS13').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg52.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('臺南市');
	...
	$('.HS15').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg53.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('高雄市');
	...
	$('.HS16').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg54.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('屏東縣 ');
	...
	$('.HS17').mouseover(function () {
		...
		$backgroundImage.stop().css('background', 'url(image/map/bg55.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('宜蘭縣 ');
	...
	$('.HS18').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg56.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('花蓮縣');
	...
	$('.HS20').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg58.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('連江縣');
	...
	$('.HS19').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg57.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('臺東縣');
	...
	$('.HS21').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg59.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('金門縣');
	...
	$('.HS22').mouseover(function () {
		$backgroundImage.stop().css('background', 'url(image/map/bg60.jpg) center center');
		$backgroundImage.stop().css('background-size');
		$title.stop().text('澎湖縣');
