...
$(document).ready(function () {
	...
	$('.HS2').click(function HS2() {
		...
		$p2.stop().append("<p class='morelink' style='color:#007bff'><a href='/Amis'>阿美族</a> 相關介紹</p>");
	});
	$('.HS3').click(function () {
		$title.stop().text('新北市');
		$p1.stop().text('原住民族群：阿美族 泰雅族');
		$p2.stop().text('新北市是臺灣最北的都市，環繞整個臺北市，總面積達二千多平方公里，幅員遼闊，新北市的東北、北部、西北部均臨海。');
		$p2.stop().append("<p class='morelink' style='color:#007bff'><a href='/Amis'>阿美族</a> <a href='/Tayal'>泰雅族</a> 相關介紹</p>");		
	});
	$('.HS4').click(function () {
		$title.stop().text('桃園市');
		$p1.stop().text('原住民族群：阿美族 泰雅族');
	...
	$('.HS5').click(function () {
		...
		$p2.stop().append("<p class='morelink' style='color:#007bff'><a href='/Tayal'>泰雅族</a> <a href='/SaySiyat'>賽夏族</a> 相關介紹</p>");		
	});
	$('.HS6').click(function () {
		$title.stop().text('新竹市');
		$p1.stop().text('原住民族群：阿美族');
	...
	$('.HS11').click(function () {
		...
		$p2.stop().append("<p class='morelink' style='color:#007bff'><a href='/Seediq'>賽德克族</a> <a href='/Bunun'>布農族</a> <a href='/Thao'>邵族</a> <a href='/Tayal'>泰雅族</a> <a href='/Tsou'>鄒族</a> 相關介紹</p>");
	});
	$('.HS12').click(function () {
		$title.stop().text('嘉義縣');
		$p1.stop().text('原住民族群：鄒族');
		$p2.stop().text('地處嘉南平原，為重要農業產區。境內水利建設堪稱完備，土地肥沃，以農產聞名。');
		$p2.stop().append("<p class='morelink' style='color:#007bff'><a href='/Tsou'>鄒族</a> 相關介紹</p>");		
	});
	$('.HS14').click(function () {
		$title.stop().text('嘉義市');
		$p1.stop().text('原住民族群：無');
	...
	$('.HS15').click(function () {
		...
		$p2.stop().append("<p class='morelink' style='color:#007bff'><a href='/Bunun'>布農族</a> <a href='/Paiwan'>排灣族</a> <a href='/Rukai'>魯凱族</a> <a href='/Saaroa'>拉阿魯哇族</a> 相關介紹</p>");		
	});
	$('.HS16').click(function () {
		$title.stop().text('屏東縣');
		...
		$p2.stop().append("<p class='morelink' style='color:#007bff'><a href='/Amis'>阿美族</a> <a href='/Paiwan'>排灣族</a> <a href='/Rukai'>魯凱族</a> 相關介紹</p>");		
	});
	$('.HS17').click(function () {
		$title.stop().text('宜蘭縣 ');
		$p1.stop().text('原住民族群：泰雅族');
		$p2.stop().text('宜蘭市位居蘭陽平原中心的精華地帶，河川縱橫提供豐富的灌溉資源，讓居於平原中央的宜蘭市擁有肥沃土地與充裕水源，成為一個農產豐饒的稻米之鄉。');
		$p2.stop().append("<p class='morelink' style='color:#007bff'><a href='/Tayal'>泰雅族</a> 相關介紹</p>");		
	});
	$('.HS18').click(function () {
		$title.stop().text('花蓮縣');
		...
		$p2.stop().append("<p class='morelink' style='color:#007bff'><a href='/Taroko'>太魯閣族</a> <a href='/Sakizaya'>撒奇萊雅族</a> <a href='/Seediq'>賽德克族</a> <a href='/Bunun'>布農族</a> <a href='/Amis'>阿美族</a> <a href='/Kavalan'>噶瑪蘭族</a> 相關介紹</p>");		
	});
	$('.HS20').click(function () {
		$title.stop().text('連江縣');
		$p1.stop().text('原住民族群：無');
	...
	$('.HS19').click(function () {
		...
		$p2.stop().append("<p class='morelink' style='color:#007bff'><a href='/Bunun'>布農族</a> <a href='/Pinuyumayan'>卑南族</a> <a href='/Amis'>阿美族</a> <a href='/Paiwan'>排灣族</a> <a href='/Yami'>達悟族</a> <a href='/Rukai'>魯凱族</a> 相關介紹</p>");		
	});
	$('.HS21').click(function () {
		$title.stop().text('金門縣');
		$p1.stop().text('原住民族群：無');
